    ...
    execute: function () {
      ...
      var LevelGenerator = exports('LevelGenerator', (_dec = ccclass('LevelGenerator'), _dec(_class = (_class2 = /*#__PURE__*/function () {
        ...
        LevelGenerator.generateLevel55 = function generateLevel55() {
          ...
          // 调整棋子种类，确保每种棋子至少有3个
          var types = Math.min(Math.floor(ziNum / 3), 45);
        ...
        LevelGenerator.generateLevel = function generateLevel(level) {
          ...
          types = Math.min(types, 20); // 限制最大种类数为20
        ...
        4: [27, 88, 89, 90, 91, 92, 93, 111, 112, 113, 114, 115, 116, 117, 118, 119, 200]
...
System.register("chunks:///_virtual/LotteryUI.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseUI.ts', './UILayer.ts', './ShopConfig.ts', './ToastManager.ts', './AdManager.ts', './AudioManager.ts', './ResConst.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Button, tween, Sprite, assetManager, SpriteFrame, UITransform, Label, sys, BaseUI, UILayer, ShopConfig, ToastManager, AdManager, AdType, AdEventType, AudioManager, createBundleObject;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/Match3UI.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SpriteFramesCfg.ts', './Match3ZiUE.ts', './ZiStack.ts', './LevelGenerator.ts', './CoinManager.ts', './TaskManager.ts', './AdManager.ts', './BagManager.ts', './SkillManager.ts', './SkillBase.ts', './AudioManager.ts', './ResConst.ts', './TuoDaoHuiMaSkill.ts', './ToastManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createForOfIteratorHelperLoose, _extends, _asyncToGenerator, cclegacy, _decorator, Node, Label, Button, Sprite, Prefab, Vec3, tween, Tween, Color, instantiate, assetManager, SpriteFrame, UITransform, director, Camera, RenderTexture, Director, Layers, Vec2, Component, RichText, ProgressBar, SpriteFramesCfg, Match3ZiUE, ZiStack, LevelGenerator, CoinEventType, CoinManager, TaskManager, AdEventType, AdType, AdManager, BagEventType, ItemType, SkillManager, SkillType, SkillEventType, AudioManager, createBundleObject, TuoDaoHuiMaSkill, ToastManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var Match3UI = exports('Match3UI', (_dec = ccclass('Match3UI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Button), _dec11 = property(Button), _dec12 = property(Button), _dec13 = property(Button), _dec14 = property(Label), _dec15 = property(Label), _dec16 = property(Button), _dec17 = property(Button), _dec18 = property(Node), _dec19 = property(Button), _dec20 = property(Button), _dec21 = property(Button), _dec22 = property(Button), _dec23 = property(Sprite), _dec24 = property(Label), _dec25 = property(Node), _dec26 = property(Prefab), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.shareToFriendForCoins = function shareToFriendForCoins() {
          ...
          if (typeof wx !== 'undefined') {
            // 使用新的用户信息获取方式
            this.getUserProfile().then(function (userInfo) {
            ...
            if (wx.getUserProfile) {
              wx.getUserProfile({
                ...
                fail: function fail(error) {
                  ...
                  _this5.getDefaultUserInfo().then(resolve)["catch"](reject);
                }
              });
            } else {
          ...
          this.m_ZiList.forEach(function (ziUE) {
            ...
            for (var _r = 0; _r < 6; _r++) {
              for (var _c = 0; _c < 6; _c++) {
                _this7.stacks[ziUE.row + _r][ziUE.col + _c].push(ziUE);
              }
            }
          });
          //刷新一次所有旗子的显示
          this.m_ZiList.forEach(function (ziUE) {
            ziUE.setClickable(_this7.calcClickable(ziUE));
          });
        }
        ...
        function () {
          var _initLevel = _asyncToGenerator(function* (level) {
            ...
            var clickFunc = function clickFunc(clickZi) {
              var isClickable = _this8.calcClickable(clickZi);
              if (!isClickable) {
                return;
              }

              // 立即播放棋子飞向收集区第一格的动画，动画完成后自动加入待处理队列
              _this8.playFlyToCollectAreaAnimation(clickZi);

              // 从棋盘上移除棋子
              _this8.removeZi(clickZi);
            };
            ...
            if (!success) {
              ...
              fallbackLevelJson.zis.forEach(function (zi) {
                try {
                  ...
                  _ziUE.node.setParent(_this8.board);
        ...
        _proto.playFlyToCollectAreaAnimation = function playFlyToCollectAreaAnimation(ziUE) {
          ...
          tween(ziUE.node).to(0.2, {
            ...
            // 动画完成后，将棋子加入待处理队列
            _this9.addCollectEventToQueue(ziUE);
          }).start();
        ...
        _proto.tryCollectingZi = function tryCollectingZi(clickZi) {
          ...
          var _loop = function _loop() {
              var zi = _this10.m_PlaceHolders[i];
              ...
              if (zi.style === clickZi.style) {
                //插入到zi后面
                _this10.m_PlaceHolders.splice(i + 1, 0, clickZi);
                //标记当前棋子是否和前面两个子形成了消除
                var elimination = [];
                if (!zi.isMarkElimnate && i >= 1 && _this10.m_PlaceHolders[i - 1].style === clickZi.style && !_this10.m_PlaceHolders[i - 1].isMarkElimnate) {
                  //形成消除
                  elimination.push(_this10.m_PlaceHolders[i - 1]);
                  elimination.push(zi);
                ...
                if (clickZi.node.position.equals(new Vec3(0, 0, 0))) {
                  // 设置棋子的z-index，确保移动时始终在上层显示
                  clickZi.node.setSiblingIndex(_this10.collectArea.children.length - 1);
                  ...
                  if (elimination.length > 0) {
                    ...
                    setTimeout(function () {
                      ...
                      var isCombo = _this10.lastEliminateTime > 0 && currentTime - _this10.lastEliminateTime <= _this10.comboTimeout;
                      if (isCombo) {
                        // 连击情况
                        _this10.comboCount++;
                        _this10.totalComboCount++;
                        console.log("\u8FDE\u51FB\uFF01\u5F53\u524D\u8FDE\u51FB\u6B21\u6570: " + _this10.comboCount + ", \u7D2F\u8BA1\u8FDE\u51FB\u6B21\u6570: " + _this10.totalComboCount);

                        // 播放连击音效
                        AudioManager.ins.playSound(createBundleObject("Res/Audio/combo", "LoginBN"));

                        // 显示连击文字动画
                        _this10.showComboTextAnimation(_this10.comboCount, elimination[1].node.position); // 使用中间棋子的位置
                      } else {
                        // 非连击情况，重置连击计数
                        _this10.comboCount = 1;
                        _this10.totalComboCount = Math.max(_this10.totalComboCount, 1); // 至少为1
                        console.log("\u6D88\u9664\uFF01\u5F53\u524D\u8FDE\u51FB\u6B21\u6570: " + _this10.comboCount + ", \u7D2F\u8BA1\u8FDE\u51FB\u6B21\u6570: " + _this10.totalComboCount);
                      ...
                      // 更新上次消除时间
                      _this10.lastEliminateTime = currentTime;

                      //消除行为
                      var startIndex = -1;
                      elimination.forEach(function (it) {
                        if (startIndex == -1) {
                          startIndex = _this10.m_PlaceHolders.indexOf(it);
                        }
                        it.node.destroy();
                      });
                      for (var z = startIndex + 3; z < _this10.m_PlaceHolders.length; z++) {
                        _this10.m_PlaceHolders[z].changeMoveingTargetIndex(z - 3);
                      }
                      _this10.m_PlaceHolders.splice(startIndex, 3);

                      // 检查收集区空位并触发警告效果
                      _this10.checkCollectAreaSpace();
                  ...
                  // 播放移动动画
                  clickZi.moveToTargetIndex(_this10.collectArea, i + 1, function () {
                    //检测清除或者失败逻辑
                    if (elimination.length > 0) {
                      // 延迟执行消除，确保棋子已经移动到最终位置
                      setTimeout(function () {
                ...
                //后面的棋子如果正在做飞行动画，更改目标
                for (var j = i + 2; j < _this10.m_PlaceHolders.length; ++j) {
                  if (!_this10.m_PlaceHolders[j].isMarkElimnate) {
                    _this10.m_PlaceHolders[j].changeMoveingTargetIndex(j);
                  }
                }
                return {
                  v: true
          ...
          var _handleRespawnAdReward = _asyncToGenerator(function* (param) {
            ...
            if (param.type === AdEventType.REWARDED) {
              ...
              yield this.executeTuoDaoHuiMaSkill().then(function (success) {
                ...
                // 启用所有棋子的点击功能
                _this12.enableAllZiClicks();
                _this12.m_IsLose = false;
              })["catch"](function (error) {
        ...
        _proto.showGameSuccess = function showGameSuccess(reward) {
          ...
          if (this.successContinueButton && this.successContinueButton.node) {
            ...
            this.successContinueButton.node.on(Button.EventType.CLICK, function () {
              _this13.onSuccessContinueClicked();
            }, this);
          } else {
          ...
          if (this.successDoubleRewardButton && this.successDoubleRewardButton.node) {
            ...
            this.successDoubleRewardButton.node.on(Button.EventType.CLICK, function () {
              _this13.onSuccessDoubleRewardClicked(reward);
            }, this);
          } else {
          ...
          if (this.successBuyButton && this.successBuyButton.node) {
            ...
            this.successBuyButton.node.on(Button.EventType.CLICK, function () {
              _this13.onSuccessBuyButtonClicked();
            }, this);
          } else {
          ...
          if (this.successShareButton && this.successShareButton.node) {
            ...
            this.successShareButton.node.on(Button.EventType.CLICK, function () {
              _this13.onSuccessShareButtonClicked();
            }, this);
          } else {
        ...
        _proto.onSuccessContinueClicked = function onSuccessContinueClicked() {
          ...
          this.nextLevel().then(function () {
            // 重置处理标志
            _this14.isProcessingContinue = false;
          })["catch"](function () {
            // 重置处理标志
            _this14.isProcessingContinue = false;
          });
        ...
        _proto.showGameFail = function showGameFail() {
          ...
          if (this.failBuyButton && this.failBuyButton.node) {
            ...
            this.failBuyButton.node.on(Button.EventType.CLICK, function () {
              _this15.onFailBuyButtonClicked();
            }, this);
          } else {
            console.error("购买按钮或其节点未设置");
          }
        ...
        _proto.displayBagItems = function displayBagItems() {
          ...
          consumables.forEach(function (item, index) {
            _this17.createItemIcon(item, index);
            // 更新当前显示的物品数据
            _this17.currentDisplayedItems.set(item.id, _extends({}, item));
          });
        ...
        _proto.createItemIcon = function createItemIcon(item, index) {
          ...
          iconButton.node.on(Button.EventType.CLICK, function () {
            _this18.onItemIconClicked(skillNode);
          }, this);

          // 设置useButton点击事件
          useButton.node.on(Button.EventType.CLICK, function () {
            _this18.onUseItemButtonClicked();
          }, this);
                ...
                if (typeof wx !== 'undefined') {
                  ...
                  wx.shareAppMessage({
                    ...
                    complete: function complete() {
                      // 重置处理标志
                      _this20.isProcessingContinue = false;
                    }
                  });
                } else {
                  // 非微信小游戏环境，使用jsb（如果可用）
...
System.register("chunks:///_virtual/ShareManager.ts", ['cc', './CoinManager.ts', './OpenDataManager.ts', './ToastManager.ts'], function (exports) {
  var cclegacy, _decorator, CoinManager, OpenDataManager, ToastManager;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
      _decorator = module._decorator;
    ...
    execute: function () {
      ...
      var ShareManager = exports('ShareManager', (_dec = ccclass('ShareManager'), _dec(_class = (_class2 = /*#__PURE__*/function () {
        ...
        _proto.init = function init() {
          ...
          if (typeof wx !== 'undefined') {
            ...
            if (launchOptions.query && launchOptions.query.from === 'share') {
              ...
              console.log("ShareManager: \u901A\u8FC7\u5206\u4EAB\u94FE\u63A5\u8FDB\u5165\uFF0C\u5C06\u83B7\u5F97" + coins + "\u91D1\u5E01");
         ...
         * @param coins 奖励金币数量
         */;
        _proto.handleShareReward = function handleShareReward(coins) {
          var _this = this;
          try {
            // 获取当前用户OpenID
            if (typeof wx !== 'undefined') {
              wx.getOpenId({
                success: function success(res) {
                  ...
                  console.log('ShareManager: 获取到用户OpenID:', openId);

                  // 检查今日是否已领取过分享奖励
                  _this.checkTodayShareReward(openId, coins);
                },
                fail: function fail(error) {
                  console.error('ShareManager: 获取用户OpenID失败:', error);
                  // 获取OpenID失败，直接给予奖励
         ...
         * @param coins 奖励金币数量
         */;
        _proto.checkTodayShareReward = function checkTodayShareReward(openId, coins) {
          var _this2 = this;
          if (typeof wx !== 'undefined') {
            // 获取用户互动数据
            wx.getUserInteractiveStorage({
              ...
              success: function success(res) {
                var data = res.data || {};
                var today = new Date().toDateString();
                var lastShareDate = data.lastShareDate || '';
                var shareRewardCount = data.shareRewardCount || 0;

                // 检查今日是否已领取过分享奖励
                if (lastShareDate === today && shareRewardCount >= 1) {
                  console.log('ShareManager: 今日已领取过分享奖励');
                  ToastManager.getInstance().showMessage('今日已领取过分享奖励', 2);
                  return;
                }

                // 给予分享奖励
                _this2.giveShareReward(coins);

                // 更新分享奖励记录
                _this2.updateShareRewardRecord(today, shareRewardCount + 1);
              },
              fail: function fail(error) {
                console.error('ShareManager: 获取用户互动数据失败:', error);
                // 获取数据失败，直接给予奖励
                _this2.giveShareReward(coins);
              }
            });
